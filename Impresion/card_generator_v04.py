...
OUTPUT_PDF = 'imprimir_cuadrado_v05.pdf' # Nombre de archivo cambiado
...
def dibujar_fondo_tarjeta(c, x, y):
    ...
    # Se reemplaza roundRect por rect para eliminar el redondeo
    c.rect(
        x + ajuste, 
        y + ajuste, 
        CARD_WIDTH - grosor_borde, 
        CARD_HEIGHT - grosor_borde, 
        stroke=1, # Activar borde
        fill=1    # Activar relleno
    )
