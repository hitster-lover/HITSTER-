...
GUIDE_COLOR = (0.2, 0.2, 0.2) # Un gris claro para las guías de corte

# --- CONFIGURACIÓN DEL ARCHIVO ---
CSV_FILE = 'binder_ESP_500.csv'
OUTPUT_PDF = 'imprimir_500_v01.pdf' # Nombre de archivo cambiado
...
def dibujar_lineas_corte(c):
    ...
    c.saveState()
    c.setStrokeColorRGB(*GUIDE_COLOR) # Usa el color gris claro definido
    c.setLineWidth(0.5) # Línea muy fina
    c.setDash([2, 3], 0) # Patrón de puntos: 2pt dibujados, 3pt de espacio
...
def dibujar_pagina(c, chunk_canciones, es_frontal):
    ...
    # Llama a la función para dibujar las guías después de todas las tarjetas de la página
